...
This project uses [Tailwind CSS](https://tailwindcss.com/) for utility-first styling. You can add Tailwind classes directly to your JSX elements.

Tailwind configuration can be found in `tailwind.config.js` and styles are imported in `globals.css`.
